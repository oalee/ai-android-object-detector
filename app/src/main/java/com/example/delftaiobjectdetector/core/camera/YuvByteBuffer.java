...
@Metadata(
        ...
        d2 = {"Lcom/example/delftaiobjectdetector/core/camera/YuvByteBuffer;", "", "image", "Landroid/media/Image;", "dstBuffer", "Ljava/nio/ByteBuffer;", "(Landroid/media/Image;Ljava/nio/ByteBuffer;)V", "buffer", "getBuffer", "()Ljava/nio/ByteBuffer;", "type", "", "getType$annotations", "()V", "getType", "()I", "clipBuffer", "start", "size", "removePadding", "", "Lcom/example/delftaiobjectdetector/core/camera/YuvByteBuffer$ImageWrapper;", "removePaddingCompact", "plane", "Lcom/example/delftaiobjectdetector/core/camera/YuvByteBuffer$PlaneWrapper;", "dst", "offset", "removePaddingNotCompact", "ImageWrapper", "PlaneWrapper", "DelftAI_Object_Detector.app.main"}
)
